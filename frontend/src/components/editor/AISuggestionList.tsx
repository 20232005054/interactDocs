...
export default function AISuggestionList({
  ...
  return (
    <div className="mt-3 rounded-lg border border-gray-200 bg-white shadow-sm overflow-hidden">
        ...
        {pendingCount > 0 && !collapsed && (
          <div className="flex items-center gap-2 animate-in fade-in slide-in-from-right-2 duration-200">
            ...
            <button
              onClick={onRejectAll}
              disabled={applyingAll}
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-md text-sm font-medium text-gray-600 hover:text-gray-700 hover:bg-gray-100 transition-all disabled:opacity-50 active:scale-95"
            >
      ...
      {/* 建议列表 */}
      {!collapsed && (
        <div className="p-3 space-y-2.5 max-h-96 overflow-y-auto animate-in fade-in slide-in-from-top-2 duration-200">
